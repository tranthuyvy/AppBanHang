...
import com.example.lezada.databinding.ActivityThemSpBinding;
import com.example.lezada.model.MessageModel;
...
public class ThemSPActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sanPhamSua == null){
            ...
            //sua
            flag = true;
            binding.btnthem.setText("Sửa sản phẩm"); //đổi text button ở trang thêm
    ...
    private void initData() {
        ...
        stringList.add("Cheap Product");
        stringList.add("Average Product");
        stringList.add("Expensive Product");
        ...
        binding.imgcamera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ImagePicker.with(ThemSPActivity.this)
                        .crop()	    			        //Cho phép cắt ảnh sau khi chọn
                        .compress(1024)			//Kích thước tệp ảnh tối đa được nén
                        .maxResultSize(1080, 1080)	//Kích thước ảnh lớn nhất
                        .start();
            }
        });
    }
    ...
    private void uploadMultipleFiles() {
        ...
        call.enqueue(new Callback <MessageModel>() {
            ...
            public void onFailure(Call < MessageModel > call, Throwable t) {
                Log.d("log", t.getMessage());   //Xem có lỗi hay không
