...
import com.example.lezada.activity.DangKiActivity;
import com.example.lezada.activity.MainActivity;
import com.example.lezada.activity.ResetPassActivity;
...
public class DangNhapActivity extends AppCompatActivity {
        ...
        btndangnhap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(str_email)){
                    ...
                    //save lại tài khoản cho lần mở app sau
    ...
    private void dangNhap(String email, String pass) {
        compositeDisposable.add(apiBanHang.dangNhap(email, pass)
                ...
                .subscribe(
                        userModel -> {
                            if (userModel.isSuccess()){ //trả về true = có dữ liệu or false
                                isLogin = true;
                                Paper.book().write("islogin", isLogin);
                                Utils.user_current = userModel.getResult().get(0); //lấy phần tử đầu tiên của list
