...
import com.example.lezada.activity.ChiTietActivity;
...
public class SamsungProductAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            tensp = itemView.findViewById(R.id.itemcheapproduct_ten);
            giasp = itemView.findViewById(R.id.itemcheapproduct_gia);
            mota = itemView.findViewById(R.id.itemcheapproduct_mota);
            hinhanh = itemView.findViewById(R.id.itemcheapproduct_image);
